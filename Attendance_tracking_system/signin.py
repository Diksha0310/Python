...
def forget_pass():
    ...
    background=ImageTk.PhotoImage(file="F:/SEM-4/PYTHON/Attendance_tracking_system/college_img/background.jpg")
...
def hide():
    openeye.config(file='F:/SEM-4/PYTHON/Attendance_tracking_system/college_img/closeye.png')
    passwordEntry.config(show='*')
    eyeButton.config(command=show)

def show():
    openeye.config(file='F:/SEM-4/PYTHON/Attendance_tracking_system/college_im//openeye.png')
    passwordEntry.config(show='')
...
background=ImageTk.PhotoImage(file="F:/SEM-4/PYTHON/Attendance_tracking_system/college_img/bg.jpg")
...
openeye=PhotoImage(file="F:/SEM-4/PYTHON/Attendance_tracking_system/college_img/openeye.png")
...
fb_logo=PhotoImage(file="F:/SEM-4/PYTHON/Attendance_tracking_system/college_img/facebook.png")
fbLabel=Label(Login_window,image=fb_logo,bg='white')
fbLabel.place(x=640,y=440)

google_logo=PhotoImage(file="F:/SEM-4/PYTHON/Attendance_tracking_system/college_img/google.png")
goggleLabel=Label(Login_window,image=google_logo,bg='white')
goggleLabel.place(x=690,y=440)

twitter_logo=PhotoImage(file="F:/SEM-4/PYTHON/Attendance_tracking_system/college_img/twitter.png")
