...
def show():
    ...
    query='select student.id,name,course,status,date,time from student,attendance where student.id=%s'
...
logo_image=PhotoImage(file='F:/SEM-4/PYTHON/Attendance_tracking_system/college_img/students.png')
